...
export default class Select extends Component {
        ...
        this.dropdownMenuDom.addEventListener(
          ...
          () => {
            ...
            if (
              st + oh >= sh &&
              !page.loading &&
              (page.count ? page.pageNo * page.pageSize < page.count : true)
            ) {
            ...
            if (
              page.count &&
              page.pageNo * page.pageSize >= page.count &&
              !this.state.page.all
            ) {
              this.setState({
                ...this.state,
  ...
  renderOptions() {
    const { valueName, displayName, page } = this.props
    let { data = [] } = this.props
    ...
    return (
      <div>
        ...
        <AntdSelect
          ...
          style={style}
          notFoundContent={
            this.state.loading ? <Spin size="small" /> : '无匹配结果'
          }
          ...
          onSelect={value => {
            ...
            onSelect(
              value,
              data.find(item => item[this.props.valueName || 'id'] === value)
            )
          }}
